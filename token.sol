...
contract ENCRYPT is Context, IERC20, Ownable {
    ...
    address payable public _taxWallet = payable(0x0F1251896DD276bfb1EC33921e8882687489D96c);


    uint256 public _buyTax = 35; //Buy fee
    uint256 public _sellTax = 35; // sell fee


    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 100000000 * 10**_decimals; // Total supply
    string private constant _name = unicode"ENCRYPT";  // Name
    string private constant _symbol = unicode"$ENCR"; // Symbol
